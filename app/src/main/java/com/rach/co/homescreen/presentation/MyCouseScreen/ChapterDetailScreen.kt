...
fun ChapterDetailScreen(
    ...
    val isPremium by adViewModel.isPremium.collectAsState(initial = false)
    ...
    Column(
        ...
        LazyColumn {
            ...
            itemsIndexed(chaptersS) { index, chapterS ->
                ...
                Card(
                        ...
                        .clickable {
                            if (isPremium){
                                if (chapterS.ytlink.isNotEmpty()) {
                                    ...
                                    val pdfencode = Uri.encode(chapterS.pdflink)

                                    navController.navigate(
                                        "videoplayscreen/$encodedLink/$pdfencode"
                                    )
                            ...
                            else if (adViewModel.interstitialAd == null){
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = "${index + 1}. ${chapterS.ChapterName}",
